...
public class UnderwaterLife extends PApplet {
  ...
  @Override
  public void setup() {
    this.getSurface().setTitle("Underwater Life"); // Displays the title of the display window
    /* TODO: Complete the implementation of this method */
    backgroundImage = this.loadImage("images" + File.separator + "oceanfloor2.jpg");
    InteractiveObject.setProcessing(this);

    loadGameSettings("clues" + File.separator + "underwater.clues");
  }
